...
class Dialog extends Component<DialogProps, DialogState> {
  ...
  protected onPropsChange(prevProps: Omit<DialogProps, 'engine'>, newProps: Omit<DialogProps, 'engine'>): void {
  ...
  public render(): JSXElement {
    return this.state.open ? (
      <div ref={this.containerRef} onClick={this.props.onClose} class="dialog-container fade">
        <div class="dialog-body" onClick={(e: MouseEvent) => e.stopPropagation()}>Salam</div>
      </div>
    ) : '';
  }
}
